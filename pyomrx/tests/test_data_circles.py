...
def test_optimise_grid_fit_x_translate():
...
def test_optimise_grid_fit_x_y_translate():
...
def test_optimise_grid_fit_x_y_translate_rotate_grow():
    candidate_circles = [(9, 10, 3), (9, 10, 3)]
...
def test_find_closest_distance_misorder():
...
def test_adjust_grid_grow_double():
    circles = np.array([(0, 0, 3), (0, 1, 3), (1, 1, 3), (1, 0, 3)])
...
def test_rotate_points_around_origin():
    circles = np.array([(0, 0, 3), (0, 1, 3), (1, 1, 3), (1, 0, 3)])
