...
class BinaryCircles:
    ...
    def _extract_value(self):
        ...
        bare_circles_list = extract_circles_grid(
...
class DataCircleGroup:
    ...
    def extract_values(self):
        ...
        self._values = pd.DataFrame(values, columns=columns)
        return True
...
def extract_circles_grid(image,
    ...
    expected_locations = expected_circle_locations(circles_per_row, row_height,
                                                   column_width)
