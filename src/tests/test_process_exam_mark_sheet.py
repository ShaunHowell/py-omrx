...
from tests.fixtures import clean_out_folder, example_exam_data_path, example_exam_data_path_2
from omr.core import response_from_darknesses
...
def test_process_exam_mark_sheet_2(clean_out_folder, example_exam_data_path_2):
